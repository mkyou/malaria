...
ggsave('results/legacy/erros_vivax_2018.png')
...
ggsave('results/legacy/erros_vivax_2018_corrigido.png')
...
test_errors_vivax |> 
  write_csv('results/legacy/test_metrics_microrregion_vivax.csv')

df_vivax_pre |> write_csv('results/legacy/preds_microrregion_vivax_df.csv')
