...
real_rates_test = real_rates_all[test_idx]
  ...
  nbinomial_fit3_rate_all = nbinomial_fit3$summary.fitted.values$mode*
    100000/micro_v$populacao
  nbinomial_rate_test = nbinomial_fit3_rate_all[test_idx]
  ...
  test_errors_vivax |> write_csv('results/legacy/test_metrics_microrregion_vivax.csv')

  micro_v$bell_preds = bell_fit3_rate_all
  micro_v$nbinomial_preds = nbinomial_fit3_rate_all
  ...
  micro_v |>
    ...
    ) |> write_csv('results/legacy/preds_microrregion_vivax_df.csv')
